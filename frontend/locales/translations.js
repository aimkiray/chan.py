export const translations = {
  zh: {
    ...
    sidebar: {
      ...
      presetDynamicThreshold: "ATR动态阈值策略",
      analyze: "开始分析",
      analyzing: "正在分析",
      download: "下载历史数据",
      downloading: "下载中...",
    ...
    strategy: {
      ...
      portfolioTopN: "组合持仓数 (Top N)",
      holdingPeriod: "持仓周期 (K线数)",
      highVolAtrPctMin: "高波动过滤(ATR%)下限",
      ampWhitelistEnable: "启用振幅Top30%白名单",
      ampWhitelistDays: "振幅统计窗口(天)",
      ampWhitelistTopFrac: "振幅白名单比例(Top)",
      useAtrLabel: "使用 ATR 动态标签阈值",
      atrPeriod: "ATR 周期",
      atrMult: "ATR 倍数",
      profitThreshold: "收益阈值(标签)",
      useAutoProfitThreshold: "使用自适应阈值（按分位数）",
      autoProfitQuantile: "自适应分位数",
      profitLookahead: "盈利观察窗口(K线数)",
      startDate: "起始日期",
      endDate: "结束日期",
      forceRefresh: "强制重新训练（忽略缓存）",
    ...
    portfolio: {
      ...
      maxDD: "最大回撤",
      finalEquity: "最终净值",
      simpleBacktest: "简易向量回测 (创业板50)",
      autoPlaceholder: "留空则自动选择",
      add: "添加",
      cancel: "取消"
    },
    signal_desc: {
  ...
  en: {
    ...
    sidebar: {
      ...
      presetDynamicThreshold: "ATR Dynamic Threshold",
      analyze: "Analyze",
      analyzing: "Analyzing...",
    ...
    strategy: {
      ...
      portfolioTopN: "Portfolio Top N",
      holdingPeriod: "Holding Period (Bars)",
      highVolAtrPctMin: "High Vol ATR% Min",
      ampWhitelistEnable: "Enable Amp Top30% Whitelist",
      ampWhitelistDays: "Amp Lookback Days",
      ampWhitelistTopFrac: "Amp Top Fraction",
      profitThreshold: "Profit Threshold (Label)",
      useAutoProfitThreshold: "Use Auto Threshold (Quantile)",
      autoProfitQuantile: "Auto Quantile",
      profitLookahead: "Profit Lookahead (Bars)",
      startDate: "Start Date",
      endDate: "End Date",
      forceRefresh: "Force Retrain (Ignore Cache)",
    ...
    portfolio: {
      ...
      positions: "Positions",
      price: "Price",
      modelKey: "Model Key (Optional)",
      totalReturn: "Total Return",
      sharpe: "Sharpe Ratio",
      maxDD: "Max Drawdown",
      finalEquity: "Final Equity",
      simpleBacktest: "Simple Vector Backtest (ChiNext 50)",
